...
**本文档修改自[官方文档](https://doc.fastgpt.run/docs/)。**

**该项目为基于ChatGLM2、FastGPT的本地化项目，该文档旨在提供项目的使用方法参考**
...
以任何违反可接受使用政策的方式使用，包括但不限于法律、法规、政府命令或法令禁止的任何用途，或任何侵犯他人权利的使用，产生的后果由使用者自行承担。
...
我们禁止使用我们对接的模型服务生成可能对个人或社会造成伤害的内容。
